...
export default function About() {
    return (
        <>
            <Helmet>
                <title> About Us JC Drink – Our Journey </title>
                <meta
                    name="description"
                    content="Learn about JC Drink, our journey, mission, and commitment to crafting high-quality cold drinks and refreshing beverages made with pure ingredients and great taste."
                />
                <link rel="canonical" href="https://jcdrink.com/about" />
            </Helmet>
                        ...
                        <div className="drinks-grid">
                            <div className="drink-card">
                                <div className="drink-image-wrapper">
                                    <img src="marquee-2.webp" alt="Fresh Orange Juice" />
                            ...
                            <div className="drink-card">
                                <div className="drink-image-wrapper">
                                    <img src="X-Factor-(2).webp" alt="Tropical Blend" />
                                    <div className="drink-overlay">
                                        <div className="drink-overlay-content">
                                            <h3>X Factor</h3>
                            ...
                            <div className="drink-card">
                                <div className="drink-image-wrapper">
                                    <img src="marquee-4.webp" alt="Citrus Mint" />
                                    <div className="drink-overlay">
                                        <div className="drink-overlay-content">
                                            <h3>Tangy Orange</h3>
