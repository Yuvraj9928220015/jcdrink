...
exports.submitContactForm = async (req, res) => {
  try {
    ...
    await transporter.sendMail({
      from: `"JC Drink Distributor Form" <${process.env.EMAIL_USER}>`,
      to: ADMIN_EMAIL,
      replyTo: email,
